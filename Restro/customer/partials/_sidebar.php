  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard">
        <img src="../admin/assets/img/brand/bgpos.svg" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt='Image placeholder' src='../admin/assets/img/brand/bgpos.svg'>
              </span>
            </div>
          </a>
        ...
        <div class="navbar-collapse-header d-md-none">
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="dashboard">
                <img src="../admin/assets/img/brand/bgpos.svg">
              </a>
            </div>
